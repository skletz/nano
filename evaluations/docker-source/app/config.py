...
OUT_CONOVER_FILE = "posthoc_conover"
OUT_WELCH_FILE = "welch"
OUT_HOWELL_FILE = "howell"
...
ALL_STATISTICS = [OUT_NORM_FILE, OUT_SPEAR_FILE, OUT_CONOVER_FILE, OUT_KRUSKAL_FILE, OUT_WELCH_FILE, OUT_HOWELL_FILE, OUT_MIXED_ANOVA_FILE, OUT_FRIEDMAN_FILE, OUT_DUNN_FILE]
